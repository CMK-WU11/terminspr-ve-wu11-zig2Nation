...
export default function Footer() {
    return(
        <footer className="bg-[#EAEAEA] w-full flex items-center justify-between p-4 fixed bottom-4">
            <Link className="flex items-center justify-center w-[2em] h-[2em] border border-black rounded-full" href="/alleDanse" aria-label="til forsiden"><FiHome className=" w-[1.2em] h-[1.2em]"/></Link>
